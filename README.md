...
- Configure / Connect to your VM (Virtual Machine) with Remote Desktop using Azure
- Install / Enable IIS 
...
<img src="https://i.imgur.com/yFq2KcG.png" height="70%" width="70%" alt="image of vm username password"/> 
